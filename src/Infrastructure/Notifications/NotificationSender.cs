...
using static de.WebApi.Shared.Notifications.NotificationConstants;
...
public class NotificationSender : INotificationSender
{
    ...
    public NotificationSender(IHubContext<NotificationHub> notificationHubContext) => _notificationHubContext = notificationHubContext;
