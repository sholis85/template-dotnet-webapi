namespace de.WebApi.Host.Configurations;
    ...
    internal static ConfigureHostBuilder AddConfigurations(this ConfigureHostBuilder host)
    {
        host.ConfigureAppConfiguration((context, config) =>
        {
            ...
            config.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/apiclientsettings.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/apiclientsettings.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
